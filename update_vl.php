						...
						<div class="card mb-3">
                            ...
                            <div class="card">
                                <div class="card-header" role="tab" id="headingTwo">
                                  ...
                                  <div class="card-body">
                                  <form method="POST" action="update_vldb.php">
                                  <div class="form-group">
                                    ...
                                    <div class="form-row">
										...
										<input type="submit" name="update" href="update_vldb.php?serial_number=<?php echo $row["serial_number"];?>" class="btn btn-primary"value="Update Vendor License Details">
